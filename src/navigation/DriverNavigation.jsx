...
import PassengerDitails from '../screens/driver/PassengerDitails'
...
import ToOrigin from "../screens/driver/ToOrigin";
...
export default function DriverNavigation() {
  ...
  return (
    <Stack.Navigator screenOptions={globalScreenOptions}>
      ...
      {isFullyVerified() && (
        <Stack.Screen name={screens.passengerDitails} component={PassengerDitails} />
      )}
      ...
      {isFullyVerified() && (
        <Stack.Screen name={screens.toOrigin} component={ToOrigin} />
      )}
